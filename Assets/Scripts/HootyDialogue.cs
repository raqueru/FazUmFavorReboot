...
public class HootyDialogue : MonoBehaviour

{
    ...
    void checkquest()
    {
        if (Quests.quests[0] == true &&_inventory.itemtag=="")
        {
            for(int i=0;i<2; i++){
                   gameObject.transform.GetChild(i).gameObject.SetActive(false);
             }
        ...
        else if (Quests.quests[1] == true&&_inventory.itemtag=="")
        {
           for(int i=0;i<4; i++){
                   gameObject.transform.GetChild(i).gameObject.SetActive(false);
             }
